            ...
            <div className="flex justify-center">
                <div className="text-xs mb-3 xl:w-96">
                    <div className="relative mb-4 flex w-full flex-wrap items-stretch">
                        <input 
                            type="search"
                            className="relative m-0 block w-[1%] min-w-0 flex-auto rounded border border-solid border-yellow-400 bg-transparent bg-clip-padding px-3 py-1 text-base font-normal text-white outline-none transition duration-300 ease-in-out focus:border-yellow-400 focus:text-white focus:shadow-yellow-400 focus:outline-none dark:border-neutral-600 dark:text-neutral-200 dark:placeholder:text-neutral-200"
                            placeholder="Search"
                            id='searchBar'
                            aria-label="Search"
                        ...
                        <span
                            ...
                            id="basic-addon2">
                            <button className="px-4 py-4 text-black text-center bg-yellow-400 rounded-full hover:text-yellow-400  hover:bg-black hover:shadow-[0_8px_9px_-4px_rgba(255,255,0,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] " onClick={logValue}> 
